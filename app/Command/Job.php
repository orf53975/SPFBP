...
class Job
{
    ...
    public static function DailyJob()
    {
        ...
        #https://github.com/yanranxiaoxi/QWU-Fork/blob/master/update.php

        $copywrite = file_get_contents("https://github.com/yanranxiaoxi/QWU-Fork/raw/master/copywrite.rar");
        ...
        if ($newmd5 != $oldmd5) {
            ...
            $qqwry = file_get_contents("https://github.com/yanranxiaoxi/QWU-Fork/raw/master/qqwry.rar");
            if ($qqwry != "") {
    ...
    public static function CheckJob()
    {
        ...
        $latest_content = file_get_contents("https://github.com/yanranxiaoxi/SPFBP/master/bootstrap.php");
            ...
            if ($newmd5 == $oldmd5) {
                ...
                if (!file_exists(BASE_PATH."/storage/update.md5")) {
                    foreach ($adminUser as $user) {
                        ...
                        $to = $user->email;
                        $text = "管理员您好，系统发现有了新版本，您可以到 <a href=\"https://github.com/yanranxiaoxi/SPFBP\">https://github.com/yanranxiaoxi/SPFBP</a> 按照步骤进行升级。" ;
                        try {
                            Mail::send($to, $subject, 'news/warn.tpl', [
                                "user" => $user,"text" => $text
                            ], [
