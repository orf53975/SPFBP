					...
					<div class="dropdown margin-right">
						...
						{if $user->isLogin}
							...
							<ul class="dropdown-menu dropdown-menu-right">								
								...
								<li>
									<a class="padding-right-lg waves-attach" href="/user/edit"><i class="icon icon-lg margin-right">info</i>&nbsp;修改资料</a>
								</li>
								<li>
				...
				<ul class="nav">
					<li>
						...
						<ul class="menu-collapse collapse in" id="ui_menu_me">
                            ...
                            <li>
								<a href="/user/edit" class="padding-right-lg waves-attach"><i class="icon icon-lg">info</i>&nbsp;修改资料</a>
							</li>
						</ul>
						...
						<ul class="menu-collapse collapse in" id="ui_menu_help">
							...
							<li>
								<a href="/user/node"><i class="icon icon-lg">router</i>&nbsp; 节点/教程/流量</a>
							</li>
						</ul>
						...
						<a class="waves-attach sub" data-toggle="collapse" href="#ui_menu_detect">审计</a>
