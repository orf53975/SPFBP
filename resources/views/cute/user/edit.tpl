							...
							<div class="card-main">
								<div class="card-inner">
									<div class="card-inner">
										...
										<p>注意1：如果需要兼容原版 SS 请选择带 _compatible 的兼容选项！</p>
							...
							<div class="card-main">
								<div class="card-inner">
									<div class="card-inner">
										...
										<p><i class="icon icon-lg" aria-hidden="true">tablet_mac</i><a href="https://itunes.apple.com/cn/app/google-authenticator/id388497605">&nbsp;iOS</a></p>
							...
							<div class="card-main">
								<div class="card-inner">
									<div class="card-inner">
										...
										<p>格式请参照 <a href="https://adblockplus.org/filters">https://adblockplus.org/filters</a></p>
										<p>IP 段请使用类似 |127.0.0.0/8 格式表示</p>
										<div class="form-group form-group-label">
